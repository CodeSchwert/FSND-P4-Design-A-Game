...
class GameP1(ndb.Model):
    ...
    def new_game(cls, user, size):
        ...
        game = GameP1(user=user, size=size, turns=0, game_over=False)
        game.put()
        return game
    ...
    def end_game(self, won=False):
        ...
        score = ScoreP1(user=self.user, date=date.today(), won=won, self.turns)
        score.put()
...
class GameFormP1(messages.Message):
    ...
    turns = messages.IntegerProperty(4, required=True)
